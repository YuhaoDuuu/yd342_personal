...
class Borg:
    ...
    def __init__(self, numberOfVariables, numberOfObjectives, numberOfConstraints, function, seed, epsilons=None, bounds=None, directions=None):
        ...
        self.function = _functionWrapper(function, seed, numberOfVariables, numberOfObjectives, numberOfConstraints, directions)
...
def _functionWrapper(function, seed, numberOfVariables, numberOfObjectives, numberOfConstraints, directions=None):
    ...
    def innerFunction(v,o,c):
        ...
        global terminate
        try:
            result = function(seed, *[v[i] for i in range(numberOfVariables)])
            objectives = None
            constraints = None
