...
def makeFigure2():
    DPS = np.loadtxt('DPS.resultfile')
    DPSmostRel = np.argmin([DPS[:,1]]) # one of several solutions with perfect reliability; in paper, row 26 of DPS.resultfile was plotted
